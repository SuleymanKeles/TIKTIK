...
class _KitchenEditScreenState extends State<KitchenEditScreen> {
   ...
   TextEditingController _kitchenNameController = TextEditingController();
   TextEditingController _kitchenAboutController = TextEditingController();


  @override
  void initState() {
    super.initState();
    _kitchenNameController = new TextEditingController(text: currentKitchenName);
    _kitchenAboutController = new TextEditingController(text: currentKitchenAbout);
