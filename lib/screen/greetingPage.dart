           ...
           Row(
             ...
             children: [
               ElevatedButton(
                   ...
                   child:
                   Text(butonMessage,style: TextStyle(fontSize: 12.0,color: Colors.white,fontStyle: FontStyle.italic),)
               ),
               ///
               SizedBox(width: 20),
               ///
               ElevatedButton(
                   ...
                   child:
                   Text(buton1Message,style: TextStyle(fontSize: 12.0,color: Colors.white,fontStyle: FontStyle.italic),)
               ),
             ],
           ),
